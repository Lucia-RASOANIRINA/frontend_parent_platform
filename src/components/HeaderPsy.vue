    ...
    <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
      <div class="flex justify-between items-center h-20">
        ...
        <div class="hidden lg:flex items-center space-x-6">
          ...
          >
            ...
            <div class="flex items-center gap-1.5">
              <span class="text-[11px] font-black uppercase tracking-[0.15em] group-hover:text-[#C19A6B] transition-colors">
                {{ link.name }}
              </span>
        ...
        <div class="flex items-center space-x-4">
          ...
          <button @click="mobileMenuOpen = !mobileMenuOpen" class="lg:hidden text-[#1E293B] p-2 hover:bg-[#FAF7F2] rounded-full transition-colors relative z-50">
      ...
      <transition name="mobile-slide">
        <div v-if="mobileMenuOpen" class="lg:hidden absolute top-24 left-4 right-4 bg-white rounded-[2.5rem] shadow-2xl border border-[#FAF7F2] p-6 z-40">
          <div class="space-y-2">
...
const navLinks = [
  ...
  { name: 'Événements', path: '/psy/evenements', icon: '<svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>' },
