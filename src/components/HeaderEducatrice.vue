  ...
  >
    <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
      <div class="flex justify-between items-center h-20">
        ...
        <router-link to="/hometeacher" class="flex items-center space-x-3 group">
        ...
        <div class="hidden lg:flex items-center space-x-6">
          <router-link 
            ...
            :key="link.path" 
            :to="link.path" 
            class="relative py-2 flex items-center gap-2 text-[#3C2A21] transition-all duration-300 group"
            v-slot="{ isActive }"
          >
        ...
        <div class="flex items-center space-x-4">
          ...
          <button @click="mobileMenuOpen = !mobileMenuOpen" class="lg:hidden text-[#3C2A21] p-2 hover:bg-[#FAF7F2] rounded-full transition-colors relative z-50">
      ...
      <transition name="mobile-slide">
        <div v-if="mobileMenuOpen" class="lg:hidden absolute top-24 left-4 right-4 bg-white rounded-[2.5rem] shadow-2xl border border-[#F5F5DC] p-6 z-40">
          <div class="space-y-2">
...
const navLinks = [
  ...
  { name: 'Événements', path: '/teacher/evenements', icon: '<svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>' },
